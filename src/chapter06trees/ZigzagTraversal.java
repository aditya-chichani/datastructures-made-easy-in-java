...
public class ZigzagTraversal {
    ...
    public static void AdiZigZag(BinaryTreeNode root){
        Stack<BinaryTreeNode> stack = new Stack();
        stack.push(root);
        AdiZigZagHelper(stack,0);
    }

    private static void AdiZigZagHelper(Stack<BinaryTreeNode> stack, int flag) {
        if(stack.isEmpty())
            return;
