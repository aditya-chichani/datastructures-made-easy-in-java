...
// This class uses the variable size to check if queue is full or empty. Hence can utilise all spots!
// Here rear points to the last element :)
public class FixedSizeArrayQueueImpl {
