...
// This class uses the variable size to check if queue is full or empty. Hence can utilise all spots! Also here rear points to the space just after the last element!
